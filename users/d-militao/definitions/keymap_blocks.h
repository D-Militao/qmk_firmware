...
#define _____GAME_L3_____ KC_LSFT, KC_A, KC_S, KC_D, KC_F, KC_G
#define _____GAME_L2_____ KC_LCTL, KC_Z, KC_X, KC_C, KC_V, KC_B
#define _____GAME_L1_____ KC_ESC, KC_SPC, LT(NAV, KC_TAB)
